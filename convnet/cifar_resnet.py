...
class ResNetBasicblock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, last=False, mtl=True):
        ...
        self.conv_a = self.Conv2d(inplanes, planes, kernel_size=3, stride=stride, padding=1, bias=False)
        self.bn_a = self.BatchNorm2d(planes)

        self.conv_b = self.Conv2d(planes, planes, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn_b = self.BatchNorm2d(planes)
...
class CifarResNet(nn.Module):
    ...
    def __init__(self, block, depth, zero_init_residual=False, nf=64, mtl=True):
        ...
        channels = 3
        self.conv_1_3x3 = self.Conv2d(channels, 16, kernel_size=3, stride=1, padding=1, bias=False)
        self.bn_1 = self.BatchNorm2d(16)
